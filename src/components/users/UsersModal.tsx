...
import { X, Mail, Phone, MapPin, User as UserIcon, Lock, Image as ImageIcon } from "lucide-react";
...
export default function UserModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!nameRegex.test(formData.fullName)) {
            setToast({ type: "error", message: "Tên chỉ được chứa chữ cái và khoảng trắng, không được chứa số hoặc ký tự đặc biệt!" });
            return;
        }
