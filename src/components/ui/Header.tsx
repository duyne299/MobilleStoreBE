...
import { Search, Menu, X, User, UserCircle, Package, ClipboardList, Heart, MapPin, Shield, LogOut, Settings } from 'lucide-react';
...
export default function Header() {
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (showSuggestions && searchRef.current && !searchRef.current.contains(target)) {
    ...
    const handleCartClick = (e: React.MouseEvent) => {
        if (!isLoggedIn) {
            e.preventDefault();
            setToast({ type: 'success', message: 'Bạn cần đăng nhập để xem giỏ hàng' });
            setTimeout(() => {
    ...
    const trendingSearches = [
        { text: 'iphone 17', link: '/products?search=iphone+17' },
        { text: 'iphone 16', link: '/products?search=iphone+16' },
        { text: 'tablet', link: '/products?search=laptop' },
        { text: 'ipad', link: '/products?search=ipad' },
        { text: 'samsung', link: '/products?search=samsung' },
        { text: 'carseat', link: '/products?search=carseat' },
        { text: 'sạc dự phòng', link: '/products?search=sac+du+phong' },
        { text: 'tai nghe', link: '/products?search=may+hut+am' }
    ];
                ...
                <div className="container mx-auto">
                    ...
                    <div className="hidden lg:flex items-center justify-between gap-4 py-3 px-4 xl:px-[149px]">
                        ...
                        <div className="flex items-center gap-4 flex-1 max-w-4xl pl-16">
                            ...
                            <div className="flex-1" ref={searchRef}>
                                                ...
                                                {searchSuggestions.map((product) => (
                                                    ...
                                                    >
                                                        <div className="w-12 h-12 flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden">
                                                            <img
                                                                src={`${process.env.NEXT_PUBLIC_API_URL}${product.images?.find((img: any) => img.isCover)?.imageUrl || ''}`}
                                                                alt={product.proName}
                                ...
                                {/* Trending Searches */}
                                <div className="flex flex-wrap items-center gap-3 mt-2 text-sm pl-5">
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0 pb-8">
                                    ...
                                    <div className="absolute left-0 top-full mt-2 w-72 bg-white rounded-2xl shadow-2xl overflow-hidden z-50 border border-gray-100">
                                        ...
                                        <div className="bg-gradient-to-r from-red-600 to-red-700 p-4 text-white">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-lg">{userName || 'Người dùng'}</p>
                                                    <p className="text-sm text-red-100">{userRole === 'admin' ? 'Quản trị viên' : 'Khách hàng'}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="py-2">
                                            ...
                                            {userRole === 'admin' && (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-sm font-medium text-red-600">Trang quản lý</span>
                                                </Link>
                                            )}
                            ...
                            <Link href="/cart" className="flex-shrink-0" onClick={handleCartClick}>
                    ...
                    <div className="lg:hidden">
                                            ...
                                            <div className="bg-gradient-to-r from-red-600 to-red-700 p-3 text-white">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-red-100">{userRole === 'admin' ? 'Quản trị viên' : 'Khách hàng'}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="py-1">
                                                ...
                                                {userRole === 'admin' && (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-sm text-red-600">Trang quản lý</span>
                                                    </Link>
                                                )}
                        ...
                        <div className="px-4 pb-3" ref={searchRef}>
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-sm text-red-600 font-semibold">
                                                            {formatPrice(product.baseSalePrice || product.price)}
                                                        </p>
                                                    </div>
                                                </button>
                                            ))}
                            ...
                            <div className="flex overflow-x-auto gap-2 mt-2 text-xs pb-1 scrollbar-hide">
                                {trendingSearches.slice(0, 8).map((search, index) => (
                                    <a
                                        key={index}
                                        href={search.link}
                                        className="text-white hover:text-yellow-300 transition-colors whitespace-nowrap"
                                    >
                                        {search.text}
                                    </a>
                                ))}
