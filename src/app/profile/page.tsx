                ...
                <nav className="space-y-1">
                  {menuItems.map((item, index) => (
                    <motion.button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl text-gray-700 hover:text-red-600 transition-colors ${
                        item.label === "Đơn hàng của tôi" && showOrders
                      ...
                      <div className="grid grid-cols-3 gap-4 py-4 border-b">
                        ...
                        <div className="col-span-2">
                          <input
                            ...
                            disabled={!isEditing}
                            className={`w-full text-gray-800 font-medium bg-transparent border-none focus:outline-none ${
                              isEditing ? "border-b-2 border-blue-500 pb-1" : ""
                            }`}
                          />
                        </div>
                      </div>
